    ...
    <table class="table table-dark table-striped">
        ...
        <tbody>
            ...
            try {
                ...
                $sql = "SELECT id_consulta, examen_fisico, diagnostico, medicamento, proxima_cita, costo, id_mascotas, id_usuario FROM consultas";
                ...
                foreach ($resultados as $row) {
                    ...
                    echo "<td><button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal" . $row['examen_fisico'] . "'>Ver detalles</button></td>";
                    echo '<td><a href="actualizarconsulta.php?id=' . $row['id_consulta'] . '">Actualizar</a> | <a href="eliminarconsulta.php?id=' . $row['id_consulta'] . '">Eliminar</a></td>';

                    // Crear un modal para cada fila que muestre los detalles del cliente correspondiente
                    echo "<div class='modal fade' id='myModal" . $row['examen_fisico'] . "'>";
                    echo "<div class='modal-dialog'>";
                    echo "<div class='modal-content'>";

                    // Encabezado del modal
                    echo "<div class='modal-header'>";
                    echo "<h4 class='modal-title'>" . $row['examen_fisico'] . "</h4>";
                    echo "<button type='button' class='close' data-dismiss='modal'>&times;</button>";
                    echo "</div>";
    
                    // Cuerpo del modal
                    echo "<div class='modal-body'>";
                    echo "<p><strong>Teléfono:</strong> " . $row['diagnostico'] . "</p>";
                    echo "<p><strong>DUI:</strong> " . $row['medicamento'] . "</p>";
                    echo "<p><strong>Dirección:</strong> " . $row['proxima_cita'] . "</p>";
                    echo "<p><strong>Email:</strong> " . $row['costo'] . "</p>";
                    echo "<p><strong>Estatus:</strong> " . $row['id_mascotas'] . "</p>";
                    echo "<p><strong>Estatus:</strong> " . $row['id_usuario'] . "</p>";
                    echo "</div>";
