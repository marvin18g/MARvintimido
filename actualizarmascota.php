        ...
        <div class="box">
            <div class="inner-box">
                <div class="forms-wrap">
                    <form action="proceso_actualizarmascota.php" method="post" autocomplete="off" class="sign-in-form">
                        <div class="logo">
                        ...
                        <div class="actual-form">
                            ...
                            <h6>Name</h6>
                                <input type="hidden" name="id" value="<?= $row['id_mascotas']?>"/>
                                <input type="text"  name="nombre" id="nombre" class="input-field" autocomplete="off" required value="<?= $row['nombre']?>"/>
                            ...
                            <div class="input-wrap">
                                <input type="text"  name="raza" id="raza" class="input-field" autocomplete="off" required value="<?= $row['raza']?>" />
                                <label>Raza</label>
                            ...
                            <div class="input-wrap">
                                <input type="text"  name="color" id="color" class="input-field" autocomplete="off" required value="<?= $row['color']?>" />
                                <label>Color</label>
                            ...
                            <div class="input-wrap">
                                <input type="text"  name="peso" id="peso" class="input-field" autocomplete="off" required value="<?= $row['peso']?>" />
                                <label>Peso</label>
                            ...
                            <div class="input-wrap">
                                <input type="text"  name="altura" id="altura" class="input-field" autocomplete="off" required value="<?= $row['altura']?>" />
                                <label>Altura</label>
                            ...
                            <div class="input-wrap">
                                <input type="date"  name="fecha_nac" id="fecha_nac" class="input-field" autocomplete="off" required value="<?= $row['fecha_nac']?>" />
				...
				<select class="form-control" name="sexo" value="<?= $row['sexo']?>">
...
?>
                    ...
                    <form action="proceso_actualizarmascota.php" method="post" autocomplete="off" class="sign-up-form">
                        <div class="logo">
                            <img src="./img/logo.png" alt="easyclass" />
                            <h4>easyclass</h4>
                        </div>
