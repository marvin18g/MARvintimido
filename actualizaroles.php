        ...
        <div class="box">
            <div class="inner-box">
                <div class="forms-wrap">
                    <form action="proceso_actualizaroles.php" method="post" autocomplete="off" class="sign-in-form">
                        <div class="logo">
                        ...
                        <div class="actual-form">
                            ...
                            <h6>Name</h6>
                            <input type="hidden" name="id" value="<?= $row['id_roles']?>"/>
                                <input type="text" input name="nombre" id="nombre" class="input-field" autocomplete="off" required value="<?= $row['nombre']?>" />
                            ...
                            <h6>Status</h6>
                            <div class="input-wrap">
                                <input type="text" input name="status" id="status" class="input-field" autocomplete="off" required value="<?= $row['status']?>" />
                    ...
                    <form action="proceso_actualizaroles.ph" method="post" autocomplete="off" class="sign-up-form">
                        <div class="logo">
