        ...
        <div class="box">
            <div class="inner-box">
                <div class="forms-wrap">
                    <form action="verroles.php" method="post" autocomplete="off" class="sign-in-form">
                        <div class="logo">
				...
				<select class="form-control" name="status">
					...
					<option value="0">0</option>
                            ...
                            <input type="submit" value="Ver detalles" onclick="window.location.href='registroles.php'" id="myModal" class="sign-btn" />
                    ...
                    <form action="verroles.php" method="post" autocomplete="off" class="sign-up-form">
                        <div class="logo">
