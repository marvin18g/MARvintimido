    ...
    <table class="table table-dark table-striped">
        ...
        <tbody>
            ...
            try {
                ...
                $sql = "SELECT id_mascotas, nombre, raza, color, peso, altura, sexo, fecha_nac, id_cliente FROM mascotas";
                ...
                foreach ($resultados as $row) {
                    ...
                    echo "<p><strong>fecha:</strong> " . $row['fecha_nac'] . "</p>";
                    echo "<p><strong>id_cliente:</strong> " . $row['id_cliente'] . "</p>";
                    echo "</div>";
    
                    // Pie del modal
                    echo "<div class='modal-footer'>";
                    echo "<button type='button' class='btn btn-secondary' data-dismiss='modal'>Eliminar</button>";
